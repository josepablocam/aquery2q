...
.qser.q8.query:{
    ...
    where
    month within `month$(startYear10;startYear10 + 365 * 2),
    Id in stock1000, TradeDate >= startYear10, TradeDate <= startYear10 + 365 * 2;
...
.qpar.q9.query:{
  ...
  reduce:|;
  startDate:(-365*20)+first exec TradeDate from .aq.par.master.reduce[init;reduce;2];
